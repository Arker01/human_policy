...
# 从 convert2_1500 模型微调 - data1_legacy数据
BATCH_SIZE=64
LEARNING_RATE=5e-5  # 微调学习率
CHUNK_SIZE=100
EXPT_ID="/data1/zxlei/model/data1_legacy_from_1500"
...
LOAD_PRETRAINED_PATH="/data1/zxlei/model/convert2_ckpt/policy_last.ckpt"
