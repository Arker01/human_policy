...
LEARNING_RATE=1e-4
CHUNK_SIZE=100
EXPT_ID="/data1/zxlei/model/convert2_with_pick"
DATASET_JSON="/home/embodied/human-policy/data/convert2_with_pick.json"
MODEL_CFG="/home/embodied/human-policy/hdt/configs/models/act_resnet.yaml"
BASE_DIR="/data1/zxlei/dataset/part2/"
PROCESSED_DIR="/data1/zxlei/dataset/processed/"
