...
# ==========================================
cat > /tmp/episodes_45_95_train.json << 'EOF'
{
  "train": [
    {
...
CUDA_VISIBLE_DEVICES=0 python hdt/main.py \
    --batch_size $batch_size \
    --num_epochs 50000 \
    --lr $learning_rate \
    --chunk_size $chunk_size \
    --exptid "$expt_id" \
    --dataset_json_path /tmp/episodes_45_95_train.json \
